...
export default function SignIn() {
  ...
  return (
    <>
        <Head>
          <title>ระบบรายงานผลการเข้ารับการฝึกอบรม ที่จัดโดยหน่วยงานภายนอก (แบบ กบค.1) กรมประมง</title>
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-700">
              <span className="block">
                ระบบรายงานผลการเข้ารับการฝึกอบรม<br />
ที่จัดโดยหน่วยงานภายนอก (แบบ กบค.1) กรมประมง
